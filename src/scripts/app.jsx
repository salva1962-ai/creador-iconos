...
const PRESETS = [
    { name: "Midnight Neon", template: "neon-outer", shape: "hexagon", primary: "#8b5cf6", secondary: "#ec4899", noise: 5, gloss: false },
    { name: "Glass Apple", template: "inner-glow", shape: "rounded-square", primary: "#ffffff", secondary: "#f8fafc", noise: 0, glass: true },
    { name: "Gold 3D", template: "isometric-3d", shape: "hexagon", primary: "#fbbf24", secondary: "#d97706", gloss: true, noise: 0 },
    { name: "Retro Mesh", template: "mesh-gradient", shape: "circle", primary: "#f472b6", secondary: "#60a5fa", noise: 12, glass: false }
];
                        ...
                        <div className="space-y-8 animate-in slide-in-from-left-4 duration-300">
                            ...
                            <div className="grid grid-cols-1 gap-3 pt-4 border-t border-slate-200 dark:border-slate-800">
                                ...
                                <button
                                    ...
                                    className={`w-full p-4 rounded-3xl flex items-center justify-between transition-all ${
                                        checkerboard ? "bg-slate-900 dark:bg-white text-white dark:text-slate-900" : "bg-slate-100 dark:bg-slate-800 text-slate-600"
                                    }`}
                                >
                                    <span className="text-sm font-bold">Fondo Checkerboard</span>
                                    <div className={`w-10 h-6 rounded-full relative transition-colors ${checkerboard ? "bg-emerald-500" : "bg-slate-300 dark:bg-slate-600"}`}>
                                        <div className={`absolute top-1 w-4 h-4 bg-white rounded-full transition-all ${checkerboard ? "left-5" : "left-1"}`} />
                                    </div>
                                </button>
                            </div>
                        </div>
